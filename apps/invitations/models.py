...
class Invitation(BaseModel):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="invitations", verbose_name="소유자"
    )
    template = models.ForeignKey(
        Template, on_delete=models.SET_NULL, null=True, blank=True, related_name="invitations", verbose_name="템플릿"
    )
    ...
    wedding_location_lat = models.DecimalField(
        max_digits=10, decimal_places=8, null=True, blank=True, verbose_name="위도"
    )
    wedding_location_lng = models.DecimalField(
        max_digits=11, decimal_places=8, null=True, blank=True, verbose_name="경도"
    )
...
class RSVP(BaseModel):
    ...
    invitation = models.ForeignKey(Invitation, on_delete=models.CASCADE, related_name="rsvps", verbose_name="청첩장")
...
class Guestbook(BaseModel):
    ...
    invitation = models.ForeignKey(
        Invitation, on_delete=models.CASCADE, related_name="guestbooks", verbose_name="청첩장"
    )
