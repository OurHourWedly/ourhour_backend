...
class InvitationCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invitation
        fields = [
            'template', 'title', 'groom_name', 'groom_father_name', 'groom_mother_name', 'groom_phone',
            'bride_name', 'bride_father_name', 'bride_mother_name', 'bride_phone',
            'wedding_date', 'wedding_location_name', 'wedding_location_address',
            'wedding_location_lat', 'wedding_location_lng',
            'invitation_message', 'greeting_message', 'ending_message',
            'background_animation', 'background_color', 'font_family', 'music_url',
            'enable_rsvp', 'enable_guestbook', 'enable_account_transfer',
            'is_public', 'plan_type', 'status', 'url_slug'
        ]
...
class PublicInvitationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invitation
        fields = [
            'id', 'title', 'url_slug', 'template', 'status',
...
class RSVPSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RSVP
        fields = [
            'id', 'guest_name', 'guest_count', 'attendance_status',
            'phone', 'message', 'dietary_restrictions',
...
class GuestbookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Guestbook
        fields = [
            'id', 'author_name', 'message', 'is_public',
